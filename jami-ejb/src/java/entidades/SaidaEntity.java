...
public class SaidaEntity implements Serializable {
    ...
    public Date getData_compensacao() {
        return data_compensacao;
    }

    public void setData_compensacao(Date data_compensacao) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SaidaEntity)) {
            return false;
        }
        SaidaEntity other = (SaidaEntity) object;
    ...
    public String toString() {
        return "entidades.SaidaEntity[ id=" + id + " ]";
    }
